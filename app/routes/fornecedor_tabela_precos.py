...
from app.models import db, Fornecedor, FornecedorTabelaPrecos, MaterialBase, Usuario, AuditoriaFornecedorTabelaPrecos, Notificacao, Perfil
...
def notificar_admins_nova_tabela(fornecedor, usuario_criador):
    ...
    for admin in admins:
        ...
        notificacao = Notificacao(
            ...
            tipo='tabela_precos_pendente',
            url=f'/revisao-tabelas-admin.html'
        )
